...
int main(int argc, char** argv)
{
    try
    {
        ...
        {
            std::cerr <<
                "Usage: http-client <host> <port> <target> [<HTTP version: 1.0 or 1.1(default)>]\n" <<
                "Example:\n" <<
                "    http-client www.example.com 80 /\n" <<
                "    http-client www.example.com 80 / 1.0\n";
            return EXIT_FAILURE;
        }
